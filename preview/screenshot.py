#!/usr/bin/env python3
"""
screenshot.py — Playwright screenshot capture for the Selvedge theme preview.
...
PAGES = [
    ...
    ("02-studio.html",          1440, 900, "02-studio.png",               True),
    ("03-materials.html",       1280, 900, "03-materials.png",            True),
    ("04-workshop.html",        1280, 900, "04-workshop.png",             True),
    ("05-journal-post.html",    1200, 900, "05-journal-post.png",         True),
    ("06-shop.html",            1200, 900, "06-shop.png",                 True),
    # Mobile viewports
    ("07-front-mobile.html",     375, 812, "07-front-mobile-375.png",     True),
    ("08-materials-mobile.html", 390, 844, "08-materials-mobile-390.png", True),
    # Style variations — show palette flexibility
    ("09-undyed.html",          1200, 900, "09-undyed.png",               True),
    ("10-woad.html",            1200, 900, "10-woad.png",                 True),
]
...
async def main():
    print("Selvedge theme — screenshot capture")
    ...
    if wporg_src.exists():
        ...
        print("  → Verify the screenshot looks correct before submitting to WP.org.")
