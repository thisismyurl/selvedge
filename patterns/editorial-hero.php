...
<div class="wp-block-group selvedge-section" style="padding:0 0 var(--wp--preset--spacing--12) 0">
	...
	<div class="wp-block-media-text selvedge-editorial-hero has-media-on-the-left is-stacked-on-mobile" style="grid-template-columns:50% auto;padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16)">
		<figure class="wp-block-media-text__media">
			<img src="" alt="<?php esc_attr_e( 'Studio — woven linen, natural weld dye on undyed warp', 'selvedge' ); ?>" class="wp-image-placeholder" style="object-fit:cover" />
		</figure>
		<div class="wp-block-media-text__content" style="padding:var(--wp--preset--spacing--10) var(--wp--preset--spacing--10)">

			<!-- wp:paragraph {"className":"is-style-selvedge-eyebrow","style":{"color":{"text":"var:preset|color|ink-muted"},"spacing":{"margin":{"bottom":"var:preset|spacing|5"}}}} -->
			<p class="is-style-selvedge-eyebrow" style="color:var(--wp--preset--color--ink-muted);margin-bottom:var(--wp--preset--spacing--5)"><?php esc_html_e( 'Studio · Summer 2026', 'selvedge' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<h1 style="font-family:var(--wp--preset--font-family--newsreader);font-weight:700;font-size:var(--wp--preset--font-size--4xl);line-height:1.0;letter-spacing:-0.025em;font-optical-sizing:auto;color:var(--wp--preset--color--ink)"><?php esc_html_e( 'Weld on linen: the dyer\'s margin', 'selvedge' ); ?></h1>
			<!-- /wp:heading -->

			<!-- wp:paragraph {"className":"is-style-selvedge-lead","style":{"spacing":{"margin":{"top":"var:preset|spacing|6"}}}} -->
			<p class="is-style-selvedge-lead" style="margin-top:var(--wp--preset--spacing--6)"><?php esc_html_e( 'Natural dye practice begins long before the mordant bath. The warp colour, the weave structure, the sett — each decision either opens or forecloses what the dye can do. Weld teaches this the hard way: it rewards patience with a yellow that no synthetic colour can replicate.', 'selvedge' ); ?></p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons" style="margin-top:var(--wp--preset--spacing--8)">
				...
				<div class="wp-block-button"><a class="wp-block-button__link" href="/journal" style="border-radius:0;font-family:var(--wp--preset--font-family--jakarta);font-size:var(--wp--preset--font-size--sm);font-weight:500"><?php esc_html_e( 'Read in the journal →', 'selvedge' ); ?></a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
