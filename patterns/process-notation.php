 ...
 * Slug: selvedge/process-notation
 * Categories: selvedge-workshop
 * Viewport Width: 1280
 * Inserter: true
 * Description: Four-stage process notation using is-style-selvedge-notation. CSS counter auto-numbers. Weld accent on draft-notation headings (at heading size = WCAG AA large). Demo content uses warp/dye/weave vocabulary — no "handmade" or "craft".
 */
?>
<!-- wp:group {"className":"selvedge-section selvedge-band--ground-mid","style":{"spacing":{"padding":{"top":"var:preset|spacing|16","bottom":"var:preset|spacing|16","left":"var:preset|spacing|5","right":"var:preset|spacing|5"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group selvedge-section selvedge-band--ground-mid" style="padding-top:var(--wp--preset--spacing--16);padding-bottom:var(--wp--preset--spacing--16);padding-left:var(--wp--preset--spacing--5);padding-right:var(--wp--preset--spacing--5)">
	...
	<div class="wp-block-group" style="padding-bottom:var(--wp--preset--spacing--10)">
		...
		<p style="font-family:var(--wp--preset--font-family--jakarta);font-size:var(--wp--preset--font-size--2-xs);font-weight:600;letter-spacing:0.1em;text-transform:uppercase;color:var(--wp--preset--color--ink-muted)"><?php esc_html_e( 'Studio Method', 'selvedge' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<h2 style="font-family:var(--wp--preset--font-family--newsreader);font-weight:600;font-size:var(--wp--preset--font-size--3-xl);line-height:1.1;letter-spacing:-0.015em;font-optical-sizing:auto;color:var(--wp--preset--color--ink)"><?php esc_html_e( 'Weld on undyed warp: a process sequence', 'selvedge' ); ?></h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->

	<!-- Notation stages — counter-reset via .selvedge-process-section in skin.css -->
	<!-- wp:group {"className":"selvedge-process-section","layout":{"type":"default"}} -->
	<div class="wp-block-group selvedge-process-section">
