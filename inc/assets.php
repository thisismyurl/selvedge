 ...
 * the skin (Selvedge's personality). Each sheet depends on the previous so the
 ...
 * the selvedge/preload_fonts filter (registered in inc/skin.php).
 *
...
function enqueue_assets(): void {
	...
	$sheets = array(
		...
		'skin'  => 'assets/css/skin.css',       // [SKIN] Selvedge's layout, components, blocks, utilities.
	);
...
function preload_fonts(): void {
	 ...
	 */
	$fonts = (array) apply_filters( 'selvedge/preload_fonts', array() );
